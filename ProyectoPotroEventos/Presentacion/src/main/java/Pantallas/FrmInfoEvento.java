...
public class FrmInfoEvento extends javax.swing.JFrame {
    ...
    /**
     * Creates new form FrmInfoEvento
     */
    public FrmInfoEvento() {
        initComponents();
        JOptionPane.showMessageDialog(null, "Tiempo limitado");
    }

    public FrmInfoEvento(Coordinador coordinador) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmInfoEvento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmInfoEvento().setVisible(true);
            }
        });
    }
    
    public void iniciarContador(){
        cronometro = new javax.swing.Timer(1000, (java.awt.event.ActionEvent e) -> {
            if(tiempo > 0){
                tiempo--;
                actualizarEtiqueta();
            }else{
                cronometro.stop();
                coordinador.finalizarCompra();
            }
        });
        cronometro.start();
    }
    ...
    private void actualizarEtiqueta(){
        ...
        String formateado = String.format("%02d:%02d", min, segundos);
        timer.setText(formateado);
    }
